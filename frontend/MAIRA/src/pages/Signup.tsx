...
import { Shield, Mail, Lock, Eye, EyeOff, ArrowRight, Loader2, User } from 'lucide-react';
    ...
    if (success) {
        return (
            <div className="min-h-screen bg-[#080808] flex items-center justify-center p-6 relative overflow-hidden">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-[600px] bg-green-600/10 blur-[150px] pointer-events-none" />
                
                <div className="w-full max-w-md relative z-10 text-center">
                    <div className="rounded-3xl border border-green-500/20 bg-[#0A0A0A]/80 backdrop-blur-xl p-8 shadow-2xl">
                        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-green-600 to-emerald-600 mx-auto mb-6">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8">
                    <Link to="/" className="inline-flex items-center gap-3 group">
                        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-600 to-indigo-600 shadow-2xl shadow-violet-500/20 group-hover:shadow-violet-500/40 transition-all">
                            <Shield className="h-7 w-7 text-white" />
                        </div>
                        <span className="text-3xl font-black text-white tracking-tight">MAIRA</span>
                    </Link>
                    <p className="mt-3 text-neutral-400 text-sm">Create your account to start researching.</p>
                </div>
                ...
                <div className="rounded-3xl border border-white/10 bg-[#0A0A0A]/80 backdrop-blur-xl p-8 shadow-2xl">
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-[#0A0A0A] px-4 text-neutral-500 font-medium">or sign up with email</span>
                        </div>
                    </div>
